...
/** helper function for the fork notifications */
 ...
 * We can remove it when we can use the useSelector hook
 *
...
function ForkProject(props) {
  const { btnClass, btnContent, content, forkedTitle, handlers, namespaces } = props;
