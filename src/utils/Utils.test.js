...
describe("Commits functions", () => {
  ...
  const COMMITS = [
    {
      ...
      "authored_date": "2019-08-26T17:04:37.000+02:00",
    },
    {
      ...
      "author_name": "Fake author",
      "author_email": "no@email.abc",
      "authored_date": "2019-08-05T09:28:44.000+00:00",
    }
  ];
  ...
  it("function createDateElement", () => {
    ...
    expect(Time.isSameDay(dateObject.date, COMMITS[0].authored_date)).toBeTruthy();
  ...
  it("function createCommitsObjects", () => {
    ...
    for (const commit of COMMITS) {
      if (!last || !Time.isSameDay(commit.authored_date, last.authored_date))
        dates++;
      last = commit;
    }
