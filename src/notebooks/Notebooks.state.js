...
class NotebooksController  {
  ...
  get(key) { return this.model.get(key); }

  set(key, value) { return this.model.set(key, value); }
...
export { NotebooksModel, NotebooksHelper, ExpectedAnnotations, NotebooksController, notebooksSchema }
